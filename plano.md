...
## Estado atual — Release 0.11.7 + fundação da V1
...
| Chips multi-bit combinacionais DLS | Allowlist local ativa: `4-ADD`, EQUAL-4, `8-ADD`, `8-1AND`, `AND-3 8 bits`, `Full Adder - 8 Bits`, `(8 Bits) 8-bit Adder`, `8x2-AND`, `8x2-OR`, `8x2-XOR`, bancos reais `AND-8 Bits`/`NAND-8Bits`/`OR-8 Bits`/`XOR - 8 BIT`, `1-8MUX`, `NOT-8 Bits`, `NEGATE-8`, `16 para 8 e 4 bits`, `ZEXT-4-8`, `SEXT-4-8` e `ZEXT-4-16`, com larguras preservadas e assinaturas verificadas |
| Catálogo DLS importado | 1121 descrições; 445 com expressão escalar; allowlist multi-bit explicitamente nomeada em `4-ADD`, `EQUAL-4`, `8-ADD`, `8-1AND`, `AND-8 Bits`, `8x2-AND`, `NAND-8Bits`, `OR-8 Bits`, `8x2-OR`, `XOR - 8 BIT`, `8x2-XOR`, `AND-3 8 bits`, `Full Adder - 8 Bits`, `(8 Bits) 8-bit Adder`, `1-8MUX`, `NOT-8 Bits`, `NEGATE-8` e `16 para 8 e 4 bits`; bancos diretos/hierárquicos foram confirmados na Release 0.11.0, o mux na 0.11.1, o inversor na 0.11.2, a negação condicional na 0.11.3, o roteador misto na 0.11.4 e o expansor vetorial na 0.11.5; o expansor de sinal, na 0.11.6; o expansor vetorial de 16 bits, na 0.11.7 |
