...
## Estado atual — Release 0.10.2 + fundação da V1
...
| Chips multi-bit combinacionais DLS | Allowlist local ativa: `4-ADD` e bancos AND/NAND/OR/XOR de 8 bits, com larguras heterogêneas preservadas |
| Catálogo DLS importado | 1121 descrições; 445 com expressão escalar e 8 perfis multi-bit combinacionais materializáveis nesta fatia |
