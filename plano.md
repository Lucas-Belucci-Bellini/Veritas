...
## Estado atual — Release 0.10.5 + fundação da V1
...
| Chips multi-bit combinacionais DLS | Allowlist local ativa: `4-ADD`, EQUAL-4, `8-ADD`, `8-1AND` e bancos AND/NAND/OR/XOR de 8 bits, com larguras preservadas |
| Catálogo DLS importado | 1121 descrições; 445 com expressão escalar e 10 perfis multi-bit combinacionais materializáveis nesta fatia |
