...
const PALETTE: readonly { type: EditorComponentType; label: string; description: string }[] = [
  ...
  { type: 'nand', label: 'NAND', description: 'NÃO-E lógico' },
  { type: 'or', label: 'OR', description: 'OU lógico' },
  { type: 'nor', label: 'NOR', description: 'NÃO-OU lógico' },
  { type: 'not', label: 'NOT', description: 'Inversor' },
  { type: 'xor', label: 'XOR', description: 'OU exclusivo' },
  { type: 'xnor', label: 'XNOR', description: 'NÃO-OU exclusivo' },
    ...
    <section className="card p-4 sm:p-6" aria-labelledby="circuit-editor-title">
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button type="button" className="key text-xs" onClick={() => void saveAsCustomChip()} disabled={readOnlyCollaboration || hasSequential || issues.length > 0 || !customChips.ready || Boolean(customChips.unavailable)} title="Salvar este circuito na biblioteca local de chips; ele pode conter outros chips">
            Salvar como chip
          </button>
