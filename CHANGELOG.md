...
- A fase v2.7 permanece `Unreleased`: limites combinados por documento/worker, integração completa do preflight e do `tickAsync()` em UI/Worker/MCP/desktop, smoke visual e QA nativo ainda não foram concluídos.
