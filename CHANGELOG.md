...
- O envelope `veritas-testbenches` v1 passou a limitar cada lote a **256 documentos** e rejeitar nomes duplicados antes da escrita. O teste focal passou com **8 casos**; a prova artificial de falha entre linhas continua pendente porque o caminho normal valida todo o lote antes da transação.
