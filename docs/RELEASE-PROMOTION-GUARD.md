...
| Release candidate | `v0.9.0-rc.5` | Nenhum requisito beta. O workflow ainda executa testes, typecheck, lint, builds e smoke. |
...
```bash
RELEASE_VERSION=v0.9.0-rc.5 npm run release:guard
```
