...
| Release candidate | `v0.9.0-rc.17` | Nenhum requisito beta. O workflow executa testes, typecheck, lint, builds, readiness WASM-001, matriz golden/hardening WASM-003, benchmark comparativo e smoke; a ponte permanece opt-in e fora do produto. |
...
```bash
RELEASE_VERSION=v0.9.0-rc.17 npm run release:guard
```
