...
| Release candidate | `v0.9.0-rc.11` | Nenhum requisito beta. O workflow ainda executa testes, typecheck, lint, builds, readiness WASM-001, benchmark comparativo e smoke. |
