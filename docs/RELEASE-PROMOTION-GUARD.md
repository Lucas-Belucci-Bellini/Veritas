...
| Release candidate | `v0.9.0-rc.12` | Nenhum requisito beta. O workflow executa testes, typecheck, lint, builds, readiness WASM-001, paridade golden WASM-002, benchmark comparativo e smoke; a ponte permanece opt-in e fora do produto. |
...
```bash
RELEASE_VERSION=v0.9.0-rc.12 npm run release:guard
```
