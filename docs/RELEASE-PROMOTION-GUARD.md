...
| Release candidate | `v0.9.0-rc.10` | Nenhum requisito beta. O workflow ainda executa testes, typecheck, lint, builds, benchmark comparativo e smoke. |
...
```bash
RELEASE_VERSION=v0.9.0-rc.10 npm run release:guard
```
