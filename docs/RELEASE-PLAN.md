...
**Versão declarada no `package.json`:** `0.9.0-rc.17`
...
| --- | --- | --- |
| Versionamento | `package.json` está em `0.9.0-rc.17`; `v0.9.0-rc.16` está publicada e ainda não há release estável. | Manter as pré-releases até concluir os gates reais de beta e estabilidade. |
